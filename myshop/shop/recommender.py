...
class Recommender(object):
    """
    Класс реализует сохранение информации
    о купленных вместе товарах и подбор рекомендаций.
    ...
    def products_bought(self, products):
        """метод для сохранения и ранжирования объектов"""
    ...
    def suggest_products_for(self, products, max_result=6):
        """Возвращает рекомендуемые объекты"""
