...
def order_detail(obj):
    """Отображает более подробную информацию о заказе"""

    return mark_safe(f'<a href="{reverse("orders:admin_order_detail", args=[obj.id])}">Смотреть</a>')


def export_to_csv(modeladmin, request, queryset):
    """Скачивает CSV-файл заказов"""
